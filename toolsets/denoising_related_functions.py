...
from toolsets.chem_utils import parse_adduct, calculate_precursormz
...
def spectra_denoising(msms, smiles, adduct, mass_tolerance = 0.01):
    ...
    if len(mass_parent)==0:
        ...
        parent_ion = find_actual_parent_pmz(so.pack_spectra(mass_parent, intensity_parent) , therotical_pmz)
...
def find_actual_parent_pmz(msms,therotcial_pmz):
    ...
    return(mass_parent[left_idx:right_idx][max_idx])
